...
Open the [live interactive Python demo](https://club-operations-demo.streamlit.app/) to inspect the fixture-backed view in a browser without local setup. The main-content sport filter is visible on desktop and mobile; changing it recalculates every read-only view.
